...
const settings = {
    ...
    itemIgnoreList: { id: "userIgnoreList", name: "PIR.settings.itemIgnoreList.name", hint: "PIR.settings.itemIgnoreList.hint", label: "PIR.settings.itemIgnoreList.label" },
    propertyIgnoreList: { id: "propertyIgnoreList", name: "PIR.settings.propertyIgnoreList.name", hint: "PIR.settings.propertyIgnoreList.hint", label: "PIR.settings.propertyIgnoreList.label" },
